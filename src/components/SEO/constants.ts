export const SEO_CONSTANTS = {
  ...
  pages: {
    ...
    experience: {
      title: "Experience",
      description:
        "Professional experience at Zé Delivery, PayPal, Globo, and Yduqs - building applications used by millions",
    },
    skills: {
      title: "Skills",
      description:
        "Technical skills including React, React Native, TypeScript, Node.js, JavaScript, Python, and more",
    },
    education: {
      title: "Education",
      description:
        "Bachelor's in Information Systems and Postgraduate in Project Management",
    },
    contact: {
      title: "Contact",
      description:
